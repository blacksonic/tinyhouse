...
import { createClient, AddressComponent, GeocodingAddressComponentType, AddressType } from '@google/maps';
...
const parseAddress = (addressComponents: AddressComponent<GeocodingAddressComponentType | AddressType>[]) => {
  let country = null;
  let admin = null;
  let city = null;
