...
import { Form, Input, InputNumber, Layout, Radio, Typography, Upload, Button } from 'antd';
...
export const Host = ({ viewer }: Props) => {
  ...
  return (
    <Content className="host-content">
      <Form layout="vertical" onFinish={handleHostListing} onFinishFailed={handleHostListingFailure}>
        <div className="host__form-header">
          <Title level={3} className="host__form-title">
